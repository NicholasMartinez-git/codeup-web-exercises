...
var findHatSearchElement = document.getElementById("hat-search");
console.log(findHatSearchElement);
...
var findFlexContainerElements = document.getElementsByClassName("d-flex");
console.log(findFlexContainerElements);
...
for (var i = 0; i < findFlexContainerElements.length; i++) {
    console.log(findFlexContainerElements[i]);
}

// TODO: Find all of our div elements and store them into a variable~! Console.log the variable to see the results within!

var findDivElements = document.getElementsByTagName("div");
console.log(findDivElements)
...
console.log(findDivElements.length);
